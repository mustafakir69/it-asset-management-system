...
namespace TakipProgrami.Api.Data.Migrations
{
    ...
    [Migration("20260818082421_AddLicenseAssignmentsAndSupportActivities")]
    partial class AddLicenseAssignmentsAndSupportActivities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.License", b =>
                {
                    ...
                    b.Property<int>("LegacyUsedSeats")
                        .HasColumnType("int");
                    ...
                    b.ToTable("Licenses", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Licenses_LegacyUsedSeats_NonNegative", "[LegacyUsedSeats] >= 0");

                            t.HasCheckConstraint("CK_Licenses_TotalSeats_NonNegative", "[TotalSeats] >= 0");
                        });
                });

            modelBuilder.Entity("TakipProgrami.Api.Entities.LicenseAssignment", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("LicenseId", "EmployeeId", "AssetId")
                        .IsUnique()
                        .HasDatabaseName("UX_LicenseAssignments_ActiveTarget")
                        .HasFilter("[RevokedAt] IS NULL");

                    b.ToTable("LicenseAssignments", null, t =>
                        {
                            t.HasCheckConstraint("CK_LicenseAssignments_RevocationComplete", "([RevokedAt] IS NULL AND [RevokedByUserId] IS NULL) OR ([RevokedAt] IS NOT NULL AND [RevokedByUserId] IS NOT NULL)");

                            t.HasCheckConstraint("CK_LicenseAssignments_TargetRequired", "[EmployeeId] IS NOT NULL OR [AssetId] IS NOT NULL");
                        });
                });
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.SupportRequestActivity", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.ToTable("SupportRequestActivities", (string)null);
                });
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.LicenseAssignment", b =>
                {
                    ...
                    b.HasOne("TakipProgrami.Api.Entities.AppUser", "AssignedByUser")
                        .WithMany("LicenseAssignmentsCreated")
                        .HasForeignKey("AssignedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("TakipProgrami.Api.Entities.License", "License")
                        .WithMany("Assignments")
                        .HasForeignKey("LicenseId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TakipProgrami.Api.Entities.AppUser", "RevokedByUser")
                        .WithMany("LicenseAssignmentsRevoked")
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.SupportRequestActivity", b =>
                {
                    b.HasOne("TakipProgrami.Api.Entities.MaintenanceRequest", "MaintenanceRequest")
                        .WithMany("Activities")
                    ...
                    b.HasOne("TakipProgrami.Api.Entities.AppUser", "PerformedByUser")
                        .WithMany("SupportRequestActivities")
                        .HasForeignKey("PerformedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.AppUser", b =>
                {
                    ...
                    b.Navigation("LicenseAssignmentsCreated");

                    b.Navigation("LicenseAssignmentsRevoked");

                    b.Navigation("ResponsibleMaintenancePlans");

                    b.Navigation("StockTransactions");

                    b.Navigation("SupportRequestActivities");
                });
