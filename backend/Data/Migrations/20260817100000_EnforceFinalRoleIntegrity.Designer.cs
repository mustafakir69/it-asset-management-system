...
namespace TakipProgrami.Api.Data.Migrations
{
    ...
    [Migration("20260817100000_EnforceFinalRoleIntegrity")]
    partial class EnforceFinalRoleIntegrity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "employee-db-001",
                            CorporateEmail = "demo.kullanici1@example.test",
                        ...
                        {
                            Id = "employee-db-002",
                            CorporateEmail = "demo.kullanici2@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Department = "Finans",
                            EmployeeNo = "EMP-002",
                        ...
                        {
                            Id = "employee-db-003",
                            CorporateEmail = "demo.kullanici3@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Id = "employee-db-004",
                            CorporateEmail = "demo.kullanici4@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Id = "employee-db-005",
                            CorporateEmail = "demo.kullanici5@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Department = "Satış",
                            EmployeeNo = "EMP-005",
                        ...
                        {
                            Id = "employee-db-006",
                            CorporateEmail = "demo.kullanici6@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Department = "Muhasebe",
                            EmployeeNo = "EMP-006",
                        ...
                        {
                            Id = "employee-db-007",
                            CorporateEmail = "demo.kullanici7@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                        ...
                        {
                            Id = "employee-db-008",
                            CorporateEmail = "demo.kullanici8@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Department = "Lojistik",
                            EmployeeNo = "EMP-008",
                        ...
                        {
                            Id = "employee-db-009",
                            CorporateEmail = "demo.kullanici9@example.test",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 1, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Department = "Operasyon",
                            EmployeeNo = "EMP-009",
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.MaintenancePlan", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            NextDueAt = new DateOnly(2026, 9, 15),
                            ReminderLeadDays = 7,
                            ResponsibleUserId = "app-user-it",
                        ...
                        new
                        {
                            ...
                            NextDueAt = new DateOnly(2026, 8, 1),
                            ReminderLeadDays = 5,
                            ResponsibleUserId = "app-user-it",
                            StartDate = new DateOnly(2026, 8, 1)
                        },
                        new
                        {
                            ...
                            NextDueAt = new DateOnly(2026, 10, 10),
                            ReminderLeadDays = 10,
                            ResponsibleUserId = "app-user-it",
                        ...
                        new
                        {
                            ...
                            NextDueAt = new DateOnly(2026, 8, 20),
                            ReminderLeadDays = 7,
                            ResponsibleUserId = "app-user-it",
                        ...
                        new
                        {
                            ...
                            NextDueAt = new DateOnly(2026, 9, 8),
                            ReminderLeadDays = 7,
                            ResponsibleUserId = "app-user-it",
            ...
            modelBuilder.Entity("TakipProgrami.Api.Entities.MaintenanceRequest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Priority = "High",
                            RequestedByEmployeeId = "employee-db-001",
                            Status = "Open",
                        ...
                        new
                        {
                            ...
                            AssetId = "asset-db-008",
                            AssignedToUserId = "app-user-it",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 9, 9, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Kablosuz bağlantı aralıklarla kesiliyor.",
                            Priority = "Normal",
                            RequestedByEmployeeId = "employee-db-002",
                            Status = "Assigned",
                            Title = "Wi-Fi bağlantısı kopuyor",
                        ...
                        new
                        {
                            ...
                            CompletedByUserId = "app-user-it",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 8, 3, 9, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "Kurumsal uygulama başlatılamıyor.",
                            Priority = "Low",
                            RequestedByEmployeeId = "employee-db-002",
                            Result = "Uygulama yapılandırması yenilendi.",
                            Status = "Completed",
                            ...
                            WorkNotes = "Yapılandırma sonrası erişim test edildi."
                        });
                });
